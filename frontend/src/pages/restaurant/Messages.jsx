...
const RestaurantMessages = () => {
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      setNewMessage('');
      // Scroll to bottom? We'll handle by setting the messages state, but we might need to scroll the container.
      // For simplicity, we'll just update the state and assume the component will scroll (we can add a ref and scrollToBottom later if needed).
    } catch (err) {
  ...
  return (
    <DashboardLayout title="Messages" navLinks={[
      ...
      { path: '/restaurant/messages', label: 'Messages', active: true },
    ]}>
