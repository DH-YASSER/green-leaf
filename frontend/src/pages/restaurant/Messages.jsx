      ...
      <div className="flex bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden h-[calc(100vh-160px)] min-h-[500px]">
        ...
        <div className="w-80 border-r border-slate-100 flex flex-col bg-slate-50/50">
          <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-white">
            ...
            <button
              onClick={() => alert('To send a new message, browse suppliers and click "Chat" on their profile!')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      ...
                      <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Morocco Supplier Hub</span>
                    </div>
                  </div>
                </div>
              </div>
